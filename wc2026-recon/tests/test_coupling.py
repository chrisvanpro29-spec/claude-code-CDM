...
def test_notes_move_lambdas():
    ...
    lh, la, info = coupling.adjusted_lambdas(base_h, base_a, GOOD, WEAK, layer_on=True)
...
def test_tilt_is_bounded():
    ...
    for nh, na in [(GOOD, WEAK), (WEAK, GOOD), (GOOD, GOOD)]:
        lh, la, _ = coupling.adjusted_lambdas(base, base, nh, na, layer_on=True)
